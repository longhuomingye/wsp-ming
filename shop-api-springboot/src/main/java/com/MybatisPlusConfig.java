...
import com.fh.shop.api.common.MemberVoArgumentResolver;
...
public class MybatisPlusConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry interceptorRegistry) {
        ...
        interceptorRegistry.addInterceptor(idemInterceptor).addPathPatterns("/**");
    }
    ...
    public void addArgumentResolvers(List<HandlerMethodArgumentResolver> list) {
        list.add(memberVoArgumentResolver);
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                //创建人
                .contact(new Contact("王少鹏", "http://blog.bianxh.top/", ""))
                //版本号
                .version("1.0")
                //描述
                .description("API 描述")
